...
import { Car, MapPinCheck } from 'lucide-react';

export function AmericaDashboard() {
  return (
    <PageWrapper className="p-6 gap-6">
      <div>
        <h1 className="text-2xl font-bold font-serif">America</h1>
      </div>
      <Tabs.Root className="w-full flex-1 flex flex-col" defaultValue="states">
        ...
        <div className="flex flex-col flex-1">
          <Tabs.Panel value="states" className="flex flex-col flex-1 pt-6">
            <span>States</span>
          </Tabs.Panel>
          <Tabs.Panel value="plate-race" className="flex flex-col flex-1 pt-6 gap-6">
            <span>Plate race</span>
          </Tabs.Panel>
        </div>
      </Tabs.Root>
    </PageWrapper>
